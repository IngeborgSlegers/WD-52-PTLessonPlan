...
const birthYear = presidents.filter(president => president.year >= 1900 && president.year < 2000)
...
// don't need to return anything if we use a concise body arrow function instead of block body.
