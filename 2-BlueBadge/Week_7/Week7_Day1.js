// DAY ONE OF BLUE BADGE

// EXPECTATIONS
//  * More modules/reading/less lecture -> IRL documentation is primary point of research
//  * Make sure to read the content/analysis in the modules. Don't just skip to the code snippets
//  * There will be one project due at the end of the 10 weeks of Blue
//  * Structure:
//        - Week 1 and 2: Node (Server/back end) Modules with JS Challenges
//        - Week 3 and 4: React (Client/Front end) Modules with Node Challenges
//        - Week 5 and 6: Connect Node and React + Project Planning with React Challenges
//        - Week 7, 8, 9, and 10: Project/Lab Time
